...
This is the Fig. 3b-c scan for the many-molecule CE2 hierarchy described in
SI Sec. III-D. The initial condition is the same as CE2_many_molecules.py:
|1 photon> x |g_1 ... g_N>. The collective coupling is fixed at 0.1 eV by
using g_single = 0.1/sqrt(N) eV for each molecule number.
"""
import numpy as np
